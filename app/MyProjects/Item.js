    ...
    return (
      <View style={StyleSheet.flatten([Styles.main, style])}>
        <SVG width="100" height="100">
          <Path
            d="M82.063,22.284h-0.006c-0.029-0.874-0.734-1.573-1.612-1.589v-0.003h-3.36l-0.001,60.404l0.001,0.01
        ...
        <View style={Styles.wrapper}>
          <Text
            ...
            onPress={() => {
              ...
              Linking.openURL(link).catch(err => Tracker.trackError(err.stack));
            }}
          >
            {title}
          </Text>
