...
import Social from "../utils/Socialization";

const QQPic = require("./qq.png");
const WechatPic = require("./wechat.png");
  ...
  render() {
    ...
    return (
      <View style={Styles.content}>
        <Text style={{ color: TitleColors.H2TitleColor }}>
          感谢您看完本人简历！
        </Text>
        <View style={Styles.line} />
        <Text style={StyleSheet.flatten([Styles.text, { marginVertical: 5 }])}>
          分享到
        </Text>
        <View style={Styles.buttons}>
          ...
          <TouchableOpacity style={Styles.button} onPress={this.shareToWechat}>
            ...
            />
            <Animated.Text
              style={StyleSheet.flatten([Styles.text, { marginTop: 4 }])}
            >
              微信
            </Animated.Text>
          </TouchableOpacity>
